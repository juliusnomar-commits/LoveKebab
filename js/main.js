...
(function () {
  ...
  var translations = {
    ...
    'values.sauceItem1': { de: 'Scharfsauce — €1,00', en: 'Scharfsauce — €1.00' },
    'values.sauceItem2': { de: 'Knoblauch — €1,00', en: 'Knoblauch — €1.00' },
    'values.sauceItem3': { de: 'Sweet Chilli — €1,00', en: 'Sweet Chilli — €1.00' },
    'values.sauceItem4': { de: 'Honey Cocktailsauce — €1,00', en: 'Honey Cocktailsauce — €1.00' },
    'values.sauceItem5': { de: 'Joppiesauce — €1,00', en: 'Joppiesauce — €1.00' },
    'values.sauceItem6': { de: 'Joghurtsauce — €1,00', en: 'Joghurtsauce — €1.00' },
    'values.friesTag': { de: 'Love Friet', en: 'Love Friet' },
    'values.friesTitle': { de: 'Frisch geschnitten.', en: 'Cut fresh.' },
    'values.friesItem1': { de: 'Pommes Frites (Large) — €4,00', en: 'Pommes Frites (Large) — €4.00' },
    'values.friesItem2': { de: 'Pommes Frites mit Parmesan & Trüffelmayo — €7,50', en: 'Pommes Frites mit Parmesan & Trüffelmayo — €7.50' },
    'values.friesItem3': { de: 'Pommes Frites mit Majo, Currysauce & Röstzwiebeln — €7,50', en: 'Pommes Frites mit Majo, Currysauce & Röstzwiebeln — €7.50' },
    'values.wingsTag': { de: 'Love Wings', en: 'Love Wings' },
    'values.wingsTitle': { de: 'Frisch frittiert.', en: 'Fried fresh.' },
    'values.wingsItem1': { de: 'Classic Flavour — €7,00', en: 'Classic Flavour — €7.00' },
    'values.wingsItem2': { de: 'Parmesan Wings Flavour — €9,00', en: 'Parmesan Wings Flavour — €9.00' },
