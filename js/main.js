...
(function () {
  ...
  var translations = {
    ...
    'values.friesTitle': { de: 'Geschnitten.<br>Nicht aus der Tüte.', en: 'Cut fresh.<br>Not from a bag.' },
    'values.friesSpec': { de: 'Large&ensp;·&ensp;Parmesan &amp; Trüffelmayo&ensp;·&ensp;Mayo, Curry &amp; Röstzwiebeln', en: 'Large&ensp;·&ensp;Parmesan &amp; Truffle Mayo&ensp;·&ensp;Mayo, Curry &amp; Crispy Onions' },
    'values.wingsTitle': { de: 'Chicken Wings', en: 'Chicken Wings' },
    'values.wingsDesc': { de: 'Classic&ensp;·&ensp;Parmesan — 6er, mit Krautsalat &amp; Dip.', en: 'Classic&ensp;·&ensp;Parmesan — 6-piece, with coleslaw &amp; dip.' },
